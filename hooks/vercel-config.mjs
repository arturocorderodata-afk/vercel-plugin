 ...
 *
 * @param {string} filePath  Absolute path to vercel.json
 * @returns {{ relevantSkills: Set<string>, keys: string[] } | null}
 */
export function resolveVercelJsonSkills(filePath) {
  let content;
  try {
 ...
 * @returns {boolean}
 */
export function isVercelJsonPath(filePath) {
